'use strict';var AppController, AppModel, AppView, Collection, Controller, Model, PackageDetailsView, PackageModel, PackageView, View, When, app, backbone, http, markdown, mustache, _, _ref;
...
exports.AppModel = AppModel = (function() {
  ...
  __extends(AppModel, Collection);
  AppModel.prototype.model = PackageModel;
  AppModel.prototype.url = '../registry.json';
  AppModel.prototype.selected = null;
  AppModel.prototype.parse = function(content) {
...
exports.PackageDetailsView = PackageDetailsView = (function() {
  function PackageDetailsView() {
    PackageDetailsView.__super__.constructor.apply(this, arguments);
  }
  ...
  PackageDetailsView.prototype.render = function(_arg) {
    var model;
    model = _arg.model;
...
exports.AppView = AppView = (function() {
  ...
  AppView.prototype.initialize = function(options) {
    ...
    return this.model.bind('refresh', this.refresh);
  };
...
exports.AppController = AppController = (function() {
  ...
  AppController.prototype.select = function(name, id) {
    var model;
    if (name && (model = this.model.get(name)) && model !== this.model.selected) {
      this.view.infoView.render({
        model: model
      });
    }
    if (id) {
